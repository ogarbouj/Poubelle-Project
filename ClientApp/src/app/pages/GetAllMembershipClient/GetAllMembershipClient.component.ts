...
@Component({
  selector: 'app-GetAllMembershipClient',
  templateUrl: './GetAllMembershipClient.component.html',
  styleUrls: ['./GetAllMembershipClient.component.scss']
})
export class GetAllMembershipClientComponent implements OnInit {
