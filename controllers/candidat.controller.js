...
export function createCandidat(req, res) {
  ...
  const candidat = new Candidat({ nom, email, numéro, offres: [idAppelOffre], recycleur: idRecycleur });
...
export function deleteCandidatureByRecycleur(req, res) {
  ...
  Candidat
    .findByIdAndDelete({_id: id, recycleur })
